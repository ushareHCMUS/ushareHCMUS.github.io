...
class ReactEcharts extends React.Component {
  ...
  componentDidMount() {
    ...
    function resize() {
      ...
      resizeEvent = setTimeout(() => { echartObj.resize(); }, 200);
    }
  ...
  render() {
    let chartInstance = this.getEchartsInstance();
    if(chartInstance != undefined && this.props.shouldRedraw)
      chartInstance.clear();
    // for render
    return (
      <div
